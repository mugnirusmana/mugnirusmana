...
const AccessDenied = () => {
  ...
  return (
    <div className="w-full mt-5 mobile-md:mt-20 tablet:h-full tablet:mt-0 flex flex-col text-center items-center justify-center text-sky-900 p-5 font-anek-telugu">
      ...
      <span className="text-md">Sorry, the page you are accessing is currently not available for your account.</span>
      <span className="text-md mb-10">Try refreshing the page or clicking button bellow to go to Dashboard.</span>
